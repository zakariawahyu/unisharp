...
return [
    'nav-back'          => 'Back Directory',
    'nav-new'           => 'New Folder',
    'nav-upload'        => 'Upload',
    'nav-thumbnails'    => 'Thumbnails',
    'nav-list'          => 'List',
    'nav-sort'          => 'Sort',
    'nav-sort-asc'      => 'Sort Terlama -> Terbaru',
    'nav-sort-desc'     => 'Sort Terbaru -> Terlama',
    ...
    'error-not-folder'  => 'Please upload to folder based on today date',
    'error-max-len'     => 'Filename too long',
