...
<body>
  <div class="container-fluid" id="wrapper">
    ...
    <div class="row">
      ...
      <div class="col-sm-12 col-xs-12" id="main">
            ...
            <ul class="nav navbar-nav navbar-right">
              <li>
                  <div class="form-inline" style="padding-top:8px;">
                    <input id="search" type="text" placeholder="Search Here" class="form-control" autocomplete="off">
                    <a class="btn btn-primary btn-sm" onclick="loadItems();">Search</a>
                    <a class="btn btn-danger btn-sm" onclick="window.location.reload(true);">Reset</a>
                  </div>
              </li>
              <li>
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li>
                    <a href="#" id="list-sort-desc">
                      <i class="fa fa-sort-alpha-desc"></i> {{ trans('laravel-filemanager::lfm.nav-sort-desc') }}
                    </a>
                  </li>
                  <li>
                    <a href="#" id="list-sort-asc">
                      <i class="fa fa-sort-alpha-asc"></i> {{ trans('laravel-filemanager::lfm.nav-sort-asc') }}
                    </a>
                  </li>
                </ul>
              </li>
        ...
        <div class="visible" id="current_dir" style="padding: 10px 15px;background-color: #f8f8f8;color: #5e5e5e;margin-bottom:8px;"></div>
  ...
  <script src="{{ env('STATIC_URL') }}/js/lazy.js"></script>
  ...
  <script>
    goTo('{{$redirect}}'); /* DISABLE THIS TO UNDO REDIRECT */
    $.fn.fab = function () {
      var menu = this;
